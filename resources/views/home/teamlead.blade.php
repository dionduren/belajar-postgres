...
@section('content')
    <div class="row py-5">
        ...
        <div class="col-11 border border-1 border-dark mx-auto">
            <div class="row">
                <div class="text-center my-5">
                    <h2>Daftar Waiting List Tiket</h2>
            ...
            <div class="row">
                <div class="text-center my-5">
                    <h2>Daftar Tiket Ongoing</h2>
                    <table id="ticket-ongoing" class="table table-striped">
                        <thead>
                            <tr>
                                <th class="text-center">Nomor</th>
                                <th class="text-center">Tipe Tiket</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = new DataTable('#ticket-display', {
                ajax: {
                    url: "/api/teamlead-tiket-waiting-list/" + id_group,
                    dataSrc: ''
                },
                info: true,
                paging: true,
            ...
            table.on('click', 'button', function(e) {
                ...
                window.location = '/teamlead/detail/' + data.id;

                // alert(data[5] + "'s status is: " + data[7]);
            });

            new DataTable('#ticket-ongoing', {
                ajax: {
                    url: "/api/teamlead-tiket-ongoing-list/" + id_group,
                    dataSrc: ''
                },
                info: true,
                paging: true,
